...
<head>
    <title>Pesquisa CRUD @fahmidasclassroom.com</title>
    <link rel="stylesheet"
...
<script>
    $(document).ready(function() {
        ...
        $('#new-customer').click(function() {
            ...
            $('#customerCrudModal').html("Adicionar Novo Eleitor");
        ...
        $('body').on('click', '#edit-customer', function() {
            ...
            $.get('customers/' + customer_id + '/edit', function(data) {
                $('#customerCrudModal').html("Editar Eleitor");
        ...
        $('body').on('click', '#show-customer', function() {
            $('#customerCrudModal-show').html("Detalhes do Eleitor");
